...
export const ADMIN_SECTIONS = ['overview', 'kyc', 'users', 'transactions', 'settings'] as const;
export const USER_SECTIONS = ['overview', 'send', 'receive', 'kyc', 'transactions', 'profile'] as const;
