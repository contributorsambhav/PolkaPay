...
const abi = [
    ...
    },
    {
      ...
      "inputs": [
        ...
        {
          "indexed": false,
          "internalType": "enum LimitLib.UserTier",
          "name": "newTier",
          "type": "uint8"
        }
      ],
    ...
    },
    {
      ...
      "outputs": [
        ...
        {
          "internalType": "enum KYCLib.KYCStatus",
          "name": "status",
          "type": "uint8"
        },
        {
...
const contract = new ethers.Contract(
  "0x3fcac36FD5415e50ECA49e2B45F6B4D8893f029d" as string,
  abi,
  provider
);
(async () => {
